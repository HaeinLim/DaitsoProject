    ...
    <div class="outer">
        <div class="middle">
            <div class="inner">
                ...
                <span class="inner-detail">Unfortunately we're having trouble loading the page you are looking for. Please come back in a while.<br>
                <a href="main.do" class="btn btn-info mtl"><i class="fa fa-home"></i>&nbsp; Return home </a>
                </span>
                <!--END CONTENT-->
            </div>
        </div>
