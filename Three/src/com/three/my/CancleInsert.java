...
public class CancleInsert implements ThreeImpl {
	...
	public void three(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String memId = null;
	      ...
	      GuipDTO gdto = tdao.findGuip(guipId);
	      System.out.println(guipId);
	      int guipTotal = gdto.getGuipTotal();
	      
	      boolean cancleInsert = tdao.insertCancle(guipId, memId, guipTotal);
